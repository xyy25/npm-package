...
exports.getCircuits = exports.getScc = exports.getDiagramGroups = exports.getPaths = exports.getAngle = exports.getCenter = exports.includeChinese = exports.limit = exports.getLength = void 0;
...
function getPaths(startIndex, nodes, getAdjacent, filter = (node) => true) {
    ...
    while (queue.length) {
        ...
        paths[i] = p;
        if (!filter(v))
            continue; // 边过滤器，如果不符合要求则不考虑其邻接顶点
        // 遍历邻接顶点
...
function getDiagramGroups(nodes, getAdjacent, getRevAdjacent) {
...
function getCircuits(nodes, getAdjacent) {
    const res = [], stack = [];
