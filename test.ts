import { green, yellow, cyan, gray, Chalk } from 'chalk';
import { join, sep } from 'path';
import detect, { detectPnpm } from './src/utils/detect';
...
const rel = (...dir: string[]) => join(__dirname, ...dir);
...
const s = detectPnpm('F:\\server\\server\\logicServer\\game-server')
// detect('F:\\server\\server\\logicServer\\game-server', "pnpm");
